			...
			<div class="col-lg-8 order-lg-last dashboard-content">
					...
					if(isset($_POST['userRegistration']))
					{
						if(@$registerUser > 0)
						{
							echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
										Thank you for registering with <b>IGU Fashion Co..COM</b> Please  
				...
				<form action="" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group required-field">
										...
										<input type="text" class="form-control" name="acc_fname" placeholder="Enter your first name" required>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group required-field">
										<label for="acc-mname" class="font-weight-bold text-dark text-2">Last Name</label>
										<input type="text" class="form-control"  name="acc_lname" placeholder="Enter your last name" required>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-group required-field">
						...
						<input type="email" class="form-control"  name="acc_email" placeholder="Enter your mail address e.g. someone@gmail.com" required>
					</div>
					<div class="row">
						<div class="col-sm-12">
							<div class="row">
					...
					<div class="form-group required-field">
						...
						<input type="text" class="form-control" name="acc_address" placeholder="Enter your address please..." required>
					</div>					
					<div class="mb-2">
