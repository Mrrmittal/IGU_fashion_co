					...
					<div class="row invoice-to">
						<div class="col-md-9 col-sm-4 pull-left">
							...
							<?php
								...
								<p>'. @$shippingDetails[0]['shipcstmr_profession'] .'<br>'.'+91' .
					...
					<div class="row">
						<div class="col-md-8 col-xs-7 payment-method">
							...
							<p style="font-style: normal; font-size: 17px;" class="inv-label mt-1 mb-2"> 
								...
								<?php echo $getAmount->inAwords($getdetailsResult[0]['grand_total']) . ' INR ONLY'; ?>
							</p>
						...
						<div class="invoice-header">
							<div class="row">
								<div class="col-md-3 col-xs-2">
									<div class="invoice-title">
										<h1>invoice</h1>
										<img class="logo-print" src="public/assets/images/favicon/logoFrontEnd3.png" alt="" style="width: 220px; height: 60px;">
									</div>
								</div>
								<div class="invoice-info  col-md-9 col-xs-10">
									<div style="padding-left: 340px;">
