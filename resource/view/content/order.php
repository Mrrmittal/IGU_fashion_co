									...
									<div class="collapse" id="checkout-discount-section">
										<form action="" method="post">
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group required-field">
																...
																<input type="text" class="form-control" name="acc_Firstname" placeholder="Enter your first name" required>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group required-field">
																<label for="acc-mname">Last Name</label>
																<input type="text" class="form-control"  name="acc_Lastname" placeholder="Enter your last name" required>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="form-group required-field">
												...
												<input type="email" class="form-control"  name="acc_Emailadd" placeholder="Enter your mail address e.g. someone@gmail.com" required>
											</div>
											<div class="row">
												<div class="col-sm-12">
													<div class="row">
											...
											<div class="form-group required-field">
												...
												<input type="text" class="form-control" name="acc_Setaddress" placeholder="Enter your address please..." required>
											</div>
