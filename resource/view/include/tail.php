						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>IGU Fashion Co.'s infrastructure is manipulate with MVC Pattern and it's developed in a Raw PHP project. </p>
									<p> 
										<li> HTML5, CSS3 </li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>IGU, Rewari-123401, INDIA</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">(+91) 1800 1000 1000</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">PHP_IGU@gmail.com</a></li>
										<li><span class="contact-info-label">Working Days/Hours:</span>Mon - Sat / 9:00AM - 8:00PM</li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="https://www.igu.ac.in/" target="_blank"> MCA 3rd Sem (Batch 2022 - 2024) </a>
						</p>
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						...
						<div class="modal-body">
							...
							<p>Subscribe to the <b> IGU Fashion Co. Online Shopping</b>  newsletter <br/> to receive timely updates from your favorite products.</p>
							<form action="" method="post">
								<div class="row">
