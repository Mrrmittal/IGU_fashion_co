...
<html lang="en">
	<head>
		...
		<title> IGU Fashion Co | <?php echo $pageTitle ?> </title>
		
		<link rel="icon" type="image/icon" href="public/assets/images/favicon/faviconFrontEnd2.png">
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 100px;" width="200px"; src="public/assets/images/favicon/logoFrontEnd3.png" alt="IGU Fashion Co Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+91 1800 1000 1000</strong></a>
							</div>
