...
<html lang="en">
	...
	<?php
		...
		<meta name="author" content="Jatin Mittal">
			...
			<div class="left-side sticky-left-side">														
				<div class="logo">
					<a href="dashboard.php">
						<img src="../public/assets/images/favicon/logoBackEnd.png" alt="" height="50px" width="200px">
					</a>
				</div>
				<div class="logo-icon text-center">
					<a href="dashboard.php">
						<img src="../public/assets/images/favicon/faviconBackEnd.png" alt="" height="34px" width="34px">
					</a>
				</div>
