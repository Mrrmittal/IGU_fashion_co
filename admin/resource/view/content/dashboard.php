					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:jatinmittal164@gmail.com"> 
									<i class="fa fa-envelope"></i> &nbsp; jatinmittal164@gmail.com 
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:8801316440504" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +91 8221944248
								</a>
								<a class="btn p-follow-btn" href="#"> 
									<i class="fa fa-instagram"></i> &nbsp; Jatin Mittal
								</a>
							</div>
						</div>
					</div>
						...
						<div class="carousel slide auto panel-body" id="c-slide">
							...
							<div class="carousel-inner">
								<div class="item text-center active">
									<h3> IGU Fashion Co. | ONLINE SHOPPING STORE </h3>
									<p> E-Commerce Plateform </p>
									<p class="text-muted">
									IGU Fashion Co..com is a eCommerce application where all of the data is totally dynamic content
									</p>
								</div>
					...
					<div class="panel">
						<div class="panel-body p-states green-box">
							<div class="summary pull-left">
								...
								<h5> HTML, CSS, Boostrap,JavaScript, jQuery</h5>
							</div>
					...
					<div class="panel">
						<div class="panel-body p-states green-box">
							<div class="summary pull-left">
								...
								<h5> Microsoft Office | Indian Tax Compliances | ERP Software </h5>
							</div>
